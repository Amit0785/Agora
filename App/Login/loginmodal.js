...
const LoginModal = props => {
  ...
  const GoogleConfig = () => {
    GoogleSignin.configure({
      ...
      webClientId: '<webClientId from firebase account>', // client ID of type WEB for your server (needed to verify user ID and offline access)
  ...
  const SetGooogleLogin = async GData => {
    ...
    await axios
      .post('https://trademylist.com:8936/app/social_login', object)
      .then(async response => {
  ...
  const applelogin = async () => {
    ...
    if (credentialState === appleAuth.State.AUTHORIZED) {
      ...
      //console.log("my google login object", object);
      await axios
        .post('https://trademylist.com:8936/app_user/applelogin', object)
        .then(async response => {
          //console.log(response.data.success)
          if (response.data.success === true) {
            try {
            ...
            <View style={styles.modalBody}>
              {loder == true ? (
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  <TouchableOpacity
                    style={styles.HeadrIconContainer}
                  ...
                  <Text style={styles.accepting}>
                    if you are continue,you are accepting
                  </Text>
                  ...
                  <View
                    ...
                    <TouchableOpacity onPress={() => HandelTermsCondition()}>
                      <Text style={styles.Terms}>Terms and Conditions </Text>
                    </TouchableOpacity>
                    <Text style={styles.and}>and </Text>
                    <TouchableOpacity onPress={() => HandelPrivacyPolicy()}>
                      <Text style={styles.Privacy}>PrivacyPolicy </Text>
                    </TouchableOpacity>
                  </View>
...
const mapDispatchToProps = dispatch => {
  return {
    onChatCounterUpdate: val =>
      dispatch({type: UPDATE_CHAT_COUNTER, payload: val}),
  };
};
